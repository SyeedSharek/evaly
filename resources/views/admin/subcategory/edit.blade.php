...
<div class="container contact-form">
    ...
    <form action="{{ url('/subcategories/'.$subcategory->id) }}" method="post" enctype="multipart/form-data">
        ...
        <h3 style="color: white">Edit  Sub Category</h3>
       ...
       <div class="row">
            <div class="col-md-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" class="form-control" placeholder=" Sub Category Name" value="{{ $subcategory->name }}" required />
                </div>
                ...
                <div class="form-group">
                    <input type="submit" name="btnSubmit" class="btnContact" value="Add Sub Category" />
                </div>
            </div>
