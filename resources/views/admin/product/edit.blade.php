    ...
    <div class="box-content">
      <form class="form-horizontal" action="{{ url('/products/'.$product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <fieldset>
          ...
          <div class="controls">
            <input name="name" class="input-xlarge focused" id="focusedInput" type="text" value="{{ $product->name }}">
          </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input name="brand" class="input-xlarge focused" id="focusedInput" type="text" value="{{ $product->brand }}">
                </div>
                </div>
