...
@section('contain')
   ...
   <div class="owl-carousel owl-single home-slider">
    ...
    <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">The New Way To Display Product by <a href="{{ url('/about/') }}">Evaly</a></h1>
    ...
    <div class="item">
    <div class="untree_co-hero" style="background-image: url('images/hero_bg_6.jpg');">
    </div> 
    </div>
    </div>
      ...
      <div class="container">
       ...
       <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
        ...
        <div class="product-item">
             <a href="{{ url('/view_product/'.$product->id) }}" class="product-img">
                 <span class="custom-badge new">New</span>
                    <img style="width: 400px; height:450px;" src="{{ asset('/product_image/'.$images) }}" alt="Image" class="img-fluid">
                     </a>
